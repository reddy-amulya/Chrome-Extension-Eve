...
client = nlpcloud.Client("bart-large-cnn", "8fb4f68656d2f4edd038d83f71000d98914419a4")
# Returns a json object.
x=client.summarization("""One month after the United States began what has become a 
